...
public class QbbRpcClient {
	...
	private static final Logger log = LoggerFactory.getLogger(QbbRpcClient.class);
	...
	public static Map<String, Object> doPost(String url, String actina, byte compressType, byte encryptType, Map<String, Object> map){
		...
		try {
			...
			if (statuscode != 200) {
				...
				PacketRequest response = new PacketRequest();
				// 解析响应包的头部
				...
				log.info(url +"; actina=" + actina + "; reqData=" + map + " recv data:" + strJson);
...
/*	private static void printException(Exception cause) {
	...
	public static Map<String, Object> post(String actina, Map<String, Object> paramMap) {
		Map<String, Object> ret = null;
		ret = doPost(IConstants.service_url, actina, paramMap);
		if (ret == null) {
