...
<mapper namespace="com.qbb.${package}.dao.${fixName}Mapper">

 <resultMap id="BaseResultMap" type="com.qbb.${package}.domain.${fixName}DO" >
 	<#if meta_pk?size != 0>
 	<#list meta_pk as x>
	...
	<insert id="insert" parameterType="com.qbb.${package}.domain.${fixName}DO">
  ...
  <select id="selectByExample" resultMap="BaseResultMap" parameterType="com.qbb.${package}.domain.${fixName}DO" >
  ...
  <select id="countByExample" parameterType="com.qbb.${package}.domain.${fixName}DO" resultType="java.lang.Integer" >
...
<update id="updateByPk" parameterType="com.qbb.${package}.domain.${fixName}DO" >
    update ${tableName}
    <set >
    	<#if meta?size != 0>
 				<#list meta as x>
					<if test="${x.property}!=null and ${x.property}!=''"> 
						${x.columnName} = ${r"#{"}${x.property}},
					</if>
				</#list>
 			</#if>
    </set>
